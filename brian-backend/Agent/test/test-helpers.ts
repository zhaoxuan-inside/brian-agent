...
export const NOOP_MQ_ACCESS = { sendMQ: vi.fn().mockResolvedValue(true), getQueueStats: vi.fn().mockResolvedValue(true), consume: vi.fn(), ack: vi.fn(), nack: vi.fn(), enableMQ: vi.fn(), closeMQ: vi.fn(), initialize: vi.fn().mockResolvedValue(undefined) } as any;
...
export const NOOP_SOUL_ACCESS = { getSoul: vi.fn().mockResolvedValue(true), soSoul: vi.fn(), insertSoul: vi.fn(), updateSoul: vi.fn(), deleteSoul: vi.fn(), enableSoul: vi.fn(), closeSoul: vi.fn(), initialize: vi.fn().mockResolvedValue(undefined) } as any;
