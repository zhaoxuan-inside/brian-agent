...
export const ALL_CONFIG_REGISTRATIONS: ConfigRegistration[] = [
  ...
  // ===== 修改后（2026-09-15）：口径改为「基础上下文数量 × 占比」，随机默认 5%（基础100→5条） =====
  core('info_core', 'context_config', 'context_config.random_max_percent', '随机消息最大百分比', 'INT', 5, '随机消息采集数量相对于基础上下文数量的上限百分比 (1-100%)'),
  core('info_core', 'context_config', 'context_config.tag_relative_max_percent', '标签关联消息最大百分比', 'INT', 20, '标签关联消息采集数量相对于基础上下文数量的上限百分比 (1-100%)'),
  core('info_core', 'context_config', 'context_config.similarity_max_percent', '相似度消息最大百分比', 'INT', 15, '语义相似消息采集数量相对于基础上下文数量的上限百分比 (1-100%)'),
  core('info_core', 'context_config', 'context_config.keyword_max_percent', '关键词消息最大百分比', 'INT', 10, '关键词相关消息采集数量相对于基础上下文数量的上限百分比 (1-100%)'),
