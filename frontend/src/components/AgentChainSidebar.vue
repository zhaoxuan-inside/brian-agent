...
<template>
  <div class="fixed right-0 top-16 bottom-0 w-[360px] flex flex-col border-l border-apple-gray-200 dark:border-apple-gray-800 bg-white dark:bg-apple-gray-950 z-40">
    <!-- Header -->
